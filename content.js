...
const siteContent = {
  ...
  projects: [
    ...
    },
    {
      ...
      metaDescription: "ManMaTIC is a prospective framework connecting a knowledge field, human–machine collaboration, site conditions, and architectural impact.",
      number: "002",
      ...
      sections: [
        ...
        },
        {
          ...
          media: {
            ...
            caption: "PROTOCOL PORT / MAIN AXONOMETRIC"
          },
    ...
    },
    {
      ...
      archiveSubtitle: "A PROSPECTIVE KNOWLEDGE ENGINE FOR TESTING AND EXPANDING HUMAN–MACHINE INTEGRATION",
      navigationTitle: "ManMaTIC System — The Field",
      theme: "manmatic",
      systemMarker: "MANMATIC SYSTEM / THE FIELD",
      systemBack: "/projects/manmatic/",
      title: "The ManMaTIC Field",
      definition: "A prospective knowledge engine for testing and expanding human–machine integration",
      overview: "The ManMaTIC Field is a digital interface that brings the project’s research, thesis framework, case studies, evaluation criteria, design iterations, systems, drawings, and outputs into one connected environment. It works as a shared knowledge base between the designer and Orion, allowing ideas and decisions to be traced, tested, refined, expanded, or reduced according to the project’s own intentions, standards, limitations, and opportunities. Rather than presenting the process as separate documents, the field organises it as a readable network of knowledge, evidence, design decisions, and architectural outcomes.",
      year: "2026",
      location: "",
      category: "ManMaTIC System / The Field",
      type: "Prospective Knowledge Engine",
    ...
    },
    {
      ...
      seoTitle: "ELMA — TREE UNIT | Ahmad Alhadidii",
      ...
      number: "004",
      archiveTitle: "ELMA — TREE UNIT",
      navigationTitle: "ELMA — TREE UNIT",
      title: "ELMA — TREE UNIT",
      definition:
    ...
    },
    {
      ...
      category: "Human–Machine Protocol Environment",
      type: "Human–Machine Protocol Environment",
      role: "Architecture, research, systems thinking, visual communication",
